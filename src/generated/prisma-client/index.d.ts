...
export interface RoleScalarWhereInput {
  ...
  permissions_in?: String[] | String;
  permissions_not_in?: String[] | String;
...
export interface RoleUpdateWithWhereUniqueWithoutAttachedToInput {
  where: RoleWhereUniqueInput;
...
export interface RoleUpsertWithWhereUniqueWithoutAttachedToInput {
  where: RoleWhereUniqueInput;
  update: RoleUpdateWithoutAttachedToDataInput;
  create: RoleCreateWithoutAttachedToInput;
}

export interface RoleCreateManyWithoutAttachedToInput {
  create?:
    | RoleCreateWithoutAttachedToInput[]
    | RoleCreateWithoutAttachedToInput;
...
export interface RoleCreateWithoutAttachedToInput {
  permissions?: String;
  name: String;
}

export interface RoleUpdateWithoutAttachedToDataInput {
  permissions?: String;
  name?: String;
}
...
export interface RoleUpdateManyWithoutAttachedToInput {
  create?:
    | RoleCreateWithoutAttachedToInput[]
    | RoleCreateWithoutAttachedToInput;
  ...
  update?:
    | RoleUpdateWithWhereUniqueWithoutAttachedToInput[]
    | RoleUpdateWithWhereUniqueWithoutAttachedToInput;
  upsert?:
    | RoleUpsertWithWhereUniqueWithoutAttachedToInput[]
    | RoleUpsertWithWhereUniqueWithoutAttachedToInput;
...
export interface RolePromise extends Promise<Role>, Fragmentable {
  ...
  name: () => Promise<String>;
  attachedTo: <T = FragmentableArray<User>>(args?: {
    where?: UserWhereInput;
    orderBy?: UserOrderByInput;
    skip?: Int;
    after?: String;
...
export interface RoleSubscription
  ...
  name: () => Promise<AsyncIterator<String>>;
  attachedTo: <T = Promise<AsyncIterator<UserSubscription>>>(args?: {
    where?: UserWhereInput;
    orderBy?: UserOrderByInput;
    skip?: Int;
    after?: String;
